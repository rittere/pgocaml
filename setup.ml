...
(* OASIS_START *)
(* DO NOT EDIT (digest: 00b0c8cb17db660abc67bdd6c7326786) *)
(*
...
let setup_t =
  {
       ...
       [
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_pgocaml_lowlevel", []))];
          ...
          ("pgocaml_highlevel",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_pgocaml_highlevel", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("test_re",
     ...
     package =
       {
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Build PG'OCaml profiling utility";
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for PG'OCaml";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
                 ...
                 ({
                  ...
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EFlag "pgprof", true)
                        ];
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "utils";
                      bs_compiled_object = Byte;
                      bs_build_depends = [InternalLibrary "pgocaml"];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "make"];
                      bs_interface_patterns =
                        [
                   ...
                   {exec_custom = false; exec_main_is = "pgocaml_prof.ml"});
               Executable
                 ({
                     cs_name = "test_pgocaml_lowlevel";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "test_pgocaml_lowlevel.ml"
                   });
               Executable
                 ({
                     cs_name = "test_pgocaml_highlevel";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EAnd
                              (OASISExpr.EFlag "tests", OASISExpr.EFlag "p4"),
                             true)
                        ];
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "tests";
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "test_pgocaml_highlevel.ml"
                   });
               Executable
                 ({
                     cs_name = "test_re";
          ...
          build_custom =
            {
               pre_command =
                 [(OASISExpr.EBool true, Some (("$make", ["config"])))];
               post_command = [(OASISExpr.EBool true, None)]
            };
     ...
     oasis_digest = Some "\143\171\249(x\1409KB\138\173\016k\230\031\214";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
